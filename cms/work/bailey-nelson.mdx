...
I also added auto-tagging using GPT-4o, finetuned on existing product data to generate accurate tags for new items. This reduced manual input and improved consistency.
